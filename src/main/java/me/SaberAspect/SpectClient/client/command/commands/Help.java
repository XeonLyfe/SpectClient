...
public class Help extends Command {
	...
	public void onCommand(String[] args, String command) {
		...
		ModuleManager.addChatMessage(" Login (log) - " + TextFormatting.ITALIC + "Allows you to log into your account or another account through chat. -> " + CommandManager.prefix + "login <email>  <pass>");
